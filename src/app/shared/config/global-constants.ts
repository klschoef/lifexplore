...
export class GlobalConstants {
  ...
  public static configUSER = 'lscteam132'; //might be overriden by LocalStorage
  public static configPASS = 'OOWyxo0F9H1qg2Y'; //might be overriden by LocalStorage //'MRT7jDaRUq';
